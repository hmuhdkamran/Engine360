  ...
  <div class="login-form">
    ...
    <form class="form" id="kt_login_singin_form" action="">
      ...
      <div class="pb-5 pb-lg-15">
        ...
        <a href="javascript:;" class="text-primary font-weight-bolder">Create Account</a></div>
      </div>
      <!--begin::Title-->
      <!--begin::Form group-->
      <div class="form-group">
        <label class="font-size-h6 font-weight-bolder text-dark">Your Email</label>
        <input class="form-control h-auto py-7 px-6 rounded-lg border-0" type="email" name="username" autocomplete="off" required v-model="user.username" />
      </div>
      <!--end::Form group-->
      <!--begin::Form group-->
      <div class="form-group">
        ...
        <input class="form-control h-auto py-7 px-6 rounded-lg border-0" type="password" name="password" autocomplete="off" required v-model="user.password" />
      </div>
      <!--end::Form group-->
      <!--begin::Action-->
